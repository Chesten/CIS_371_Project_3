...
function drawTable(data) {
  ...
  data.forEach(element => {
    // temp row
    var tempDataRow = document.createElement("tr");
    var tempDataA = document.createElement("td");
    tempDataA.innerText = element.name;
    var tempDataB = document.createElement("td");
    tempDataB.innerText = element.instructions;
    var tempDataIMG = document.createElement("td");
...
theButton?.addEventListener?.("click", () => {
  ...
  } else console.log("Please enter some text");
});
// first letter
let baseInput;
let baseButton;
...
baseButton?.addEventListener?.("click", () => {
  ...
  } else console.log("Please enter one text char in first letter box");
});
...
},{}]},["6S38e","3syrK"], "3syrK", "parcelRequire3462")
